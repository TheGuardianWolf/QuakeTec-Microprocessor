...
/** The value of this variable is undefined if commandQueueEmpty = true */
volatile PL_Command_t currentCommand;
volatile bool commandQueueEmpty = true;
...
void main(void) {
    ...
    QT_TIMER_startPeriodicTask(toggleLED, 50); // testing
